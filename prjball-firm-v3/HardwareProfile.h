...
// Sample clock speed for a 16-bit processor
    ...
    #define GetSystemClock()        39613750
    ...
    #define TIMER_PERIOD                5000                    // Definition for use with a tick timer
   ...
   an SD-card-based physical layer                                   */
	...
	//PM
        ...
        // Will generate an error if the clock speed is too low to interface to the card
            ...
            #define SD_CS_ANSEL			AD1PCFGLbits.PCFG2
		    ...
		    // Description: SD-SPI Analog/Digital Select ANSEL bit
            #define SD_SCK_ANSEL	AD1PCFGLbits.PCFG2
            #define SD_SDI_ANSEL	AD1PCFGLbits.PCFG2
            #define SD_SDO_ANSEL	AD1PCFGLbits.PCFG2
